...
const Ex = (props) => {
    ...
    return (
        ...
        <strong>ATTENZIONE</strong> : Non si può associare direttamente ad <code>onClick</code> la funzione di "set" della variabile, quindi sarebbe un <RedWord>ERRORE</RedWord> scrivere :<br/>
        ...
        <strong>ATTENZIONE</strong> : Non si può dichiarare una variabile in <code>useState</code> come GLOBALE, quindi vanno dichiarate sempre solo all'interno di funzioni!<br/><br/>
